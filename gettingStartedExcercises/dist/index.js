...
let add = 5 + 3, subtract = 10 - 2, multiplication = 4 * 2, division = 16 / 2;
...
let names = ["Asad", "Fahad", "Saad", "Muneeb", "Ahmad"];
let counter = 0;
...
let locations = ["Germany", "USA", "Saudia Arabia", "France", "Norway"];
...
let fruits = new Array("Apple", "Banana", "Orange", "Grapes", "Pineapple");
...
let userNames = ["Admin", "Asad", "Fahad", "Saad", "Ahmad"];
...
let current_users = ["Abdullah", "Asad", "Fahad", "Saad", "Ahmad", "Jawad"];
// • Make another list of five usernames called new_users. Make sure one or two of the new usernames are also in the current_users list.
let new_users = ["Asad", "Mohsin", "Talha", "Ali", "Ahad"];
...
let numOrdinal = [1, 2, 3, 4, 5, 6, 7, 8, 9];
...
let fav_Pizza = ["Hot n spicy", "Tandoori", "Mushroom"];
...
let animals = ["Parrot", "Cat", "Dog", "Tiger", "loin"];
...
function make_great(originalNames) {
